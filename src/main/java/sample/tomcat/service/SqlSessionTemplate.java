...
public class SqlSessionTemplate implements SqlSession, DisposableBean {
	...
	private final ThreadLocal<SqlSession> sqlSessionThreadHolder = new ThreadLocal<SqlSession>();
	...
	public SqlSession getSqlSession(SqlSessionFactory sessionFactory, ExecutorType executorType,
			PersistenceExceptionTranslator exceptionTranslator) {

		SqlSession session = sqlSessionThreadHolder.get();
		if (session != null) {
			return session;
		}
		...
		sqlSessionThreadHolder.set(session);
